...
export const BottomNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-card" aria-label="Main navigation" role="navigation" data-walkthrough="bottom-nav">
