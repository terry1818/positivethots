...
const testUsers = [
  ...
  { email: "jordan.test@positivethots.app", name: "Jordan Lee", age: 32, pronouns: "he/him", gender: "Man", gender_preference: "Women", relationship_style: "Open relationship", relationship_status: "In a relationship", looking_for: "Casual dating", interests: ["Dancing","Technology","Cooking","Travel","Fitness"], experience_level: "experienced", bio: "Software engineer by day, salsa dancer by night. Looking for genuine connections built on trust and openness.", location: "Austin", boundaries: "Respectful communication always", imagePrompt: "Portrait photo of a 32-year-old attractive man with a confident smile, athletic build, well-groomed, wearing a casual button-up shirt, warm lighting, upper body shot" },
  ...
  { email: "dakota.test@positivethots.app", name: "Dakota James", age: 35, pronouns: "he/him", gender: "Man", gender_preference: "Women and non-binary", relationship_style: "Polyamorous", relationship_status: "In a relationship", looking_for: "Casual dating", interests: ["Cooking","Travel","Photography","Wine","Surfing"], experience_level: "veteran", bio: "Chef and traveler with a passion for exploring cultures and connections. Practiced ENM for 8 years.", location: "San Francisco", boundaries: "STI testing every 3 months", imagePrompt: "Portrait photo of a 35-year-old rugged handsome man with a chef-traveler vibe, light beard, tanned skin, confident warm expression, outdoor golden hour lighting, upper body shot" },
